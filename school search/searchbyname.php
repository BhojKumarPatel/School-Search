...
echo("<h3> Search results for $p:-</h3>");
$rsCrs=mysql_query("select s_name,s_code,s_pin,s_add,s_dist,s_state,s_email,s_yearofreg,s_classes,s_type from permanentschools where s_name like '%$p%'");
